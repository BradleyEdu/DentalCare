...
public class ArchivoPagos {
    ...
    private final String path="ArchivoPagos.obj";
    /*Declaraci�n de tabla que es de la clase Hastable
     *de tipo Persona....Hashtable es como un mapa*/

    Hashtable <String,Pagos> tabla1;
     
    public ArchivoPagos() throws IOException,ClassNotFoundException{
        FileInputStream fi;
        ...
        try{
           ...
           las clases: FileInPutStream y ObjectInputStream prepara para leer del archivo*/
            ...
            tabla1 = new Hashtable <String, Pagos> ();
        }
    }
    
    public boolean agregar(String d,Pagos c){
    ...
    public Pagos recuperar(String d){
