...
public class ArchivoDoctor {
    //en la variable path se asigna el nombre fisico del archivo
    private final String path="ArchivoDoctor.obj";
    /*Declaraci�n de tabla que es de la clase Hastable
     *de tipo Persona....Hashtable es como un mapa*/

    Hashtable <String,Doctor> tabla1;
     
    public ArchivoDoctor() throws IOException,ClassNotFoundException{
        FileInputStream fi;
        ...
        try{
           ...
           las clases: FileInPutStream y ObjectInputStream prepara para leer del archivo*/
            ...
            tabla1 = new Hashtable <String, Doctor> ();
        }
    }
    
    public boolean agregar(String d,Doctor doc){
    ...
    public Doctor recuperar(String d){
